...
- Backfilled historical market data and supported risk data analysis processes within database systems.
- Migrated services from a self-hosted environment to private cloud infrastructure while maintaining parallel system operation. This included message queue migration via implementing dual publishing to ensure zero data loss during system transition. 
- Developed backend services and SQL queries to support new system functionality and ensure data consistency. 
- Created cross-team documentation (data flows, service descriptions, dependencies), improving onboarding and collaboration, also shared knowledge via presentations. 
- Acted as release owner, coordinating between development, QA, and operations teams; managed release schedules, prepared release notes, and ensured smooth deployments with rollback plans.
...
| ------------------------------ | ------------------- |
| _Patient Services Coordinator_ | _Feb 2017–Aug 2017_ |

- Verified patient insurance eligibility and collaborated with providers to support coverage.
- Scheduled appointments and managed administrative processes including prescriptions and medical reports.
- Submitted pre-authorization requests to ensure timely approval of patient treatments.
- Acted as a key contact between patients, healthcare staff, and insurers.

| **Kulcs Patikák** | _Budapest, HUNGARY_  |
| ----------------- | -------------------- |
| _Pharmacist_      | _Aug 2015–July 2016_ |

_I worked as a pharmacist in a high-traffic pharmacy located in a busy supermarket area, where I led shifts and supervised a team of 5 colleagues._

_My responsibilities included:_
- Providing medical advice to patients with a wide range of symptoms.
- Dispensing medications accurately and efficiently.
- Preparing individualized pharmaceutical products in a laboratory environment.
- Supervising the handling and storage of controlled (narcotic) substances.
...
- Prepared medications in large quantities and weekly doses for various hospital wards.
- Compounded cytostatic infusions for cancer and other oncological treatments in a laboratory environment.
- Gained experience in daily pharmaceutical activities and patient interaction
- Provided patients with advice on medication usage, including effects and side effects.

## EDUCATION

| **Codecool**                                                | _Budapest, HUNGARY_ |
| ----------------------------------------------------------- | ------------------- |
| Full Stack Developer Student, Computer Software Engineering | _2019-2021_         |

| **University of Pécs Medical School**  | _Pecs, HUNGARY_ |
| -------------------------------------- | ----------------|
